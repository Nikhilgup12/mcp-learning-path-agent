...
# API Key input (pre-filled with default)
...
# Pipedream URLs (pre-filled with default)
st.sidebar.subheader("Pipedream URLs")
youtube_pipedream_url = st.sidebar.text_input(
    "YouTube URL (Required)",
    value=DEFAULT_YOUTUBE_PIPEDREAM_URL,
    placeholder="Enter your Pipedream YouTube URL"
)
...
# Secondary tool URL input (pre-filled with default)
if secondary_tool == "Drive":
    drive_pipedream_url = st.sidebar.text_input(
        "Drive URL",
        value=DEFAULT_DRIVE_PIPEDREAM_URL,
        placeholder="Enter your Pipedream Drive URL"
    )
    notion_pipedream_url = None
else:
    notion_pipedream_url = st.sidebar.text_input(
        "Notion URL",
        value=DEFAULT_NOTION_PIPEDREAM_URL,
        placeholder="Enter your Pipedream Notion URL"
    )
    drive_pipedream_url = None
...
st.info("""
**Quick Guide:**
1. By default, your project uses built-in Gemini API and MCP URLs.
2. You can override them in sidebar if you have your own.
3. Enter your learning goal, for example:
    - "I want to learn python basics in 3 days"
    - "I want to learn data science basics in 10 days"
""")
